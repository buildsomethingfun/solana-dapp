...
import dapp.buildsomething.repository.solana.internal.core.utilities.TweetNaclFast
...
class PublicKey {
    ...
    fun verify(signature: ByteArray, message: ByteArray): Boolean =
        TweetNaclFast.Signature(bytes, ByteArray(0)).detached_verify(message, signature)
